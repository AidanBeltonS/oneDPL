...
template <::std::uint16_t __sub_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename _KernelName>
struct __parallel_transform_reduce_sub_group_submitter;

template <::std::uint16_t __sub_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename... _Name>
struct __parallel_transform_reduce_sub_group_submitter<__sub_group_size, __iters_per_work_item, _Tp, _isComm,
                                                   __internal::__optional_kernel_name<_Name...>>
{
               ...
               _InitType __init, _Ranges&&... __rngs) const
    {
        auto __transform_pattern =
            unseq_backend::transform_reduce<_ExecutionPolicy, __iters_per_work_item, _ReduceOp, _TransformOp, _Tp, _isComm>{
                __reduce_op, __transform_op};
        auto __reduce_pattern = unseq_backend::reduce_over_sub_group<_ExecutionPolicy, _ReduceOp, _Tp, _isComm>{__reduce_op};
...
auto
__parallel_transform_reduce_sub_group_impl(_ExecutionPolicy&& __exec, const _Size __n, _ReduceOp __reduce_op,
                                       _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
{
    ...
    return __parallel_transform_reduce_sub_group_submitter<__sub_group_size, __iters_per_work_item, _Tp, _isComm,
...
template <::std::uint16_t __work_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename _KernelName>
struct __parallel_transform_reduce_small_submitter;

template <::std::uint16_t __work_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename... _Name>
struct __parallel_transform_reduce_small_submitter<__work_group_size, __iters_per_work_item, _Tp, _isComm,
                                                   __internal::__optional_kernel_name<_Name...>>
{
    template <typename _ExecutionPolicy, typename _ReduceOp, typename _TransformOp, typename _Size, typename _InitType,
              oneapi::dpl::__internal::__enable_if_device_execution_policy<_ExecutionPolicy, int> = 0,
                                       ...
                                       _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
{
    ...
    return __parallel_transform_reduce_small_submitter<__work_group_size, __iters_per_work_item, _Tp, _isComm,
                                                       _ReduceKernel>()(::std::forward<_ExecutionPolicy>(__exec), __n,
                                                                        __reduce_op, __transform_op, __init,
                                                                        ::std::forward<_Ranges>(__rngs)...);
}
...
template <::std::uint16_t __work_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename... _KernelName>
struct __parallel_transform_reduce_device_kernel_submitter<__work_group_size, __iters_per_work_item, _Tp, _isComm,
...
template <::std::uint16_t __work_group_size, ::std::uint8_t __iters_per_work_item, typename _Tp, bool _isComm,
          typename... _KernelName>
struct __parallel_transform_reduce_work_group_kernel_submitter<__work_group_size, __iters_per_work_item, _Tp, _isComm,
                                                               __internal::__optional_kernel_name<_KernelName...>>
{
    template <typename _ExecutionPolicy, typename _ReduceOp, typename _TransformOp, typename _Size, typename _InitType,
              oneapi::dpl::__internal::__enable_if_device_execution_policy<_ExecutionPolicy, int> = 0>
               ...
               _TransformOp __transform_op, _InitType __init, sycl::buffer<_Tp>& __temp, size_t __res_offset) const
    {
        ...
        auto __transform_pattern =
            unseq_backend::transform_reduce<_ExecutionPolicy, __iters_per_work_item, _ReduceOp, _NoOpFunctor, _Tp, _isComm>{
...
template <::std::uint16_t __work_group_size, ::std::uint8_t __iters_per_work_item_device_kernel,
          ::std::uint8_t __iters_per_work_item_work_group_kernel, typename _Tp, bool _isComm, typename _ReduceOp,
...
template <typename _Tp, typename _ReduceOp, typename _TransformOp, bool _isComm, typename _ExecutionPolicy,
                            ...
                            _InitType __init, _Ranges&&... __rngs)
{
    ...
    if (__work_group_size >= 256)
    {
        ...
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 64/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 128)
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 128/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 256)
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 256/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 512)
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 512/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 1024)
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 1024/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 2048)
        {
            return __parallel_transform_reduce_sub_group_impl<sg_size, 2048/sg_size, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        ...
        {
            return __parallel_transform_reduce_small_impl<256, 2, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 1024)
        {
            return __parallel_transform_reduce_small_impl<256, 4, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 2048)
        {
            return __parallel_transform_reduce_small_impl<256, 8, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
#endif
        ...
        {
            return __parallel_transform_reduce_small_impl<256, 32, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        ...
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 1, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 4194304)
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 2, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 8388608)
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 4, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 16777216)
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 8, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 33554432)
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 16, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
        else if (__n <= 67108864)
        {
            return __parallel_transform_reduce_mid_impl<256, 32, 32, _Tp, _isComm>(
                ::std::forward<_ExecutionPolicy>(__exec), __n, __reduce_op, __transform_op, __init,
                ::std::forward<_Ranges>(__rngs)...);
        }
    }
